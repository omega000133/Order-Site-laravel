            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body mt-2">
                        <h4 class="mb-2">パスワードをお忘れですか？ 🔒</h4>
                        <p class="mb-4">メールアドレスを入力してください。パスワードをリセットする手順が送信されます。</p>
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}"
                            method="POST">
                            @csrf
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" placeholder="メールを入力してください。" required
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100">リセットリンクを送信する</button>
                        </form>
